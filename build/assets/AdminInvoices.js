import{r as d,j as e}from"./vendor-query.js";import{L as Pe}from"./vendor-react.js";import{e as w,x as $e,L as De,S as Re}from"./index.js";import{B as A}from"./button.js";import{C as O,b as V,c as H,a as K}from"./card.js";import{L as b,I as v,T as W}from"./textarea.js";import{n as Fe,l as Ge,b as M,o as Le,d as _e,I as Ee,e as Q,h as ze,i as ce,a as Me}from"./vendor-ui.js";import{b as Ue,S as ae,a9 as se,D as re,a8 as qe,a6 as Be,an as Oe}from"./vendor-icons.js";import"./vendor-firebase.js";var U="Tabs",[Ve]=ze(U,[ce]),de=ce(),[He,Y]=Ve(U),le=d.forwardRef((s,n)=>{const{__scopeTabs:i,value:g,onValueChange:p,defaultValue:N,orientation:x="horizontal",dir:y,activationMode:j="automatic",...C}=s,t=Fe(y),[o,T]=Ge({prop:g,onChange:p,defaultProp:N??"",caller:U});return e.jsx(He,{scope:i,baseId:Le(),value:o,onValueChange:T,orientation:x,dir:t,activationMode:j,children:e.jsx(M.div,{dir:t,"data-orientation":x,...C,ref:n})})});le.displayName=U;var me="TabsList",ue=d.forwardRef((s,n)=>{const{__scopeTabs:i,loop:g=!0,...p}=s,N=Y(me,i),x=de(i);return e.jsx(_e,{asChild:!0,...x,orientation:N.orientation,dir:N.dir,loop:g,children:e.jsx(M.div,{role:"tablist","aria-orientation":N.orientation,...p,ref:n})})});ue.displayName=me;var pe="TabsTrigger",xe=d.forwardRef((s,n)=>{const{__scopeTabs:i,value:g,disabled:p=!1,...N}=s,x=Y(pe,i),y=de(i),j=be(x.baseId,g),C=ve(x.baseId,g),t=g===x.value;return e.jsx(Ee,{asChild:!0,...y,focusable:!p,active:t,children:e.jsx(M.button,{type:"button",role:"tab","aria-selected":t,"aria-controls":C,"data-state":t?"active":"inactive","data-disabled":p?"":void 0,disabled:p,id:j,...N,ref:n,onMouseDown:Q(s.onMouseDown,o=>{!p&&o.button===0&&o.ctrlKey===!1?x.onValueChange(g):o.preventDefault()}),onKeyDown:Q(s.onKeyDown,o=>{[" ","Enter"].includes(o.key)&&x.onValueChange(g)}),onFocus:Q(s.onFocus,()=>{const o=x.activationMode!=="manual";!t&&!p&&o&&x.onValueChange(g)})})})});xe.displayName=pe;var he="TabsContent",ge=d.forwardRef((s,n)=>{const{__scopeTabs:i,value:g,forceMount:p,children:N,...x}=s,y=Y(he,i),j=be(y.baseId,g),C=ve(y.baseId,g),t=g===y.value,o=d.useRef(t);return d.useEffect(()=>{const T=requestAnimationFrame(()=>o.current=!1);return()=>cancelAnimationFrame(T)},[]),e.jsx(Me,{present:p||t,children:({present:T})=>e.jsx(M.div,{"data-state":t?"active":"inactive","data-orientation":y.orientation,role:"tabpanel","aria-labelledby":j,hidden:!T,id:C,tabIndex:0,...x,ref:n,style:{...s.style,animationDuration:o.current?"0s":void 0},children:T&&N})})});ge.displayName=he;function be(s,n){return`${s}-trigger-${n}`}function ve(s,n){return`${s}-content-${n}`}var Ke=le,fe=ue,je=xe,Ne=ge;const We=Ke,ye=d.forwardRef(({className:s,...n},i)=>e.jsx(fe,{ref:i,className:w("inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground",s),...n}));ye.displayName=fe.displayName;const X=d.forwardRef(({className:s,...n},i)=>e.jsx(je,{ref:i,className:w("inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",s),...n}));X.displayName=je.displayName;const Qe=d.forwardRef(({className:s,...n},i)=>e.jsx(Ne,{ref:i,className:w("mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",s),...n}));Qe.displayName=Ne.displayName;const Te=d.forwardRef(({className:s,...n},i)=>e.jsx("div",{className:"relative w-full overflow-auto",children:e.jsx("table",{ref:i,className:w("w-full caption-bottom text-sm",s),...n})}));Te.displayName="Table";const we=d.forwardRef(({className:s,...n},i)=>e.jsx("thead",{ref:i,className:w("[&_tr]:border-b",s),...n}));we.displayName="TableHeader";const Se=d.forwardRef(({className:s,...n},i)=>e.jsx("tbody",{ref:i,className:w("[&_tr:last-child]:border-0",s),...n}));Se.displayName="TableBody";const Ce=d.forwardRef(({className:s,...n},i)=>e.jsx("tfoot",{ref:i,className:w("border-t bg-muted/50 font-medium [&>tr]:last:border-b-0",s),...n}));Ce.displayName="TableFooter";const P=d.forwardRef(({className:s,...n},i)=>e.jsx("tr",{ref:i,className:w("border-b transition-colors data-[state=selected]:bg-muted hover:bg-muted/50",s),...n}));P.displayName="TableRow";const S=d.forwardRef(({className:s,...n},i)=>e.jsx("th",{ref:i,className:w("h-12 px-4 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0",s),...n}));S.displayName="TableHead";const h=d.forwardRef(({className:s,...n},i)=>e.jsx("td",{ref:i,className:w("p-4 align-middle [&:has([role=checkbox])]:pr-0",s),...n}));h.displayName="TableCell";const Ze=d.forwardRef(({className:s,...n},i)=>e.jsx("caption",{ref:i,className:w("mt-4 text-sm text-muted-foreground",s),...n}));Ze.displayName="TableCaption";const ne=new Date().toISOString().slice(0,10),ie=s=>{const n=s==="tax"?"TAX":"PRO",i=new Date().toISOString().slice(0,10).replace(/-/g,"");return`${n}-${i}-${String(Date.now()).slice(-4)}`},oe=()=>({id:crypto.randomUUID(),productId:"",description:"",sku:"",quantity:1,unitPrice:0,taxRate:18}),Xe=100,Ye=30,f=(s,n)=>new Intl.NumberFormat("en-IN",{style:"currency",currency:n,maximumFractionDigits:2}).format(Number.isFinite(s)?s:0),u=s=>s.replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n]||n),$=s=>s.quantity*s.unitPrice,z=s=>s.taxRate>0?$(s)/(1+s.taxRate/100):$(s),Z=s=>$(s)-z(s);function ct(){const[s,n]=d.useState("proforma"),[i,g]=d.useState([]),[p,N]=d.useState(""),[x,y]=d.useState(!1),[j,C]=d.useState([oe()]),[t,o]=d.useState({invoiceNumber:ie("proforma"),invoiceDate:ne,dueDate:ne,sellerName:"Luxtronics",sellerAddress:"Luxtronics Online Store",sellerTaxId:"",bankAccountName:"",bankAccountNumber:"",bankIfsc:"",customerCompanyName:"",customerName:"",customerAddress:"",customerTaxId:"",currency:"INR",notes:"Thank you for choosing Luxtronics."}),{toast:T}=$e(),D=d.useRef(0),G=d.useCallback(async({search:a="",fetchAll:m=!1}={})=>{const r=D.current+1;D.current=r,y(!0);try{const c=[];let l=1,k=1;const L=m?Xe:Ye,_=a.trim();do{const F=new URLSearchParams({per_page:String(L),page:String(l),status:"publish",orderby:"title",order:"asc"});_&&F.set("search",_);const B=await fetch(`/api/woo/products?${F.toString()}`),E=await B.json();if(!B.ok||E.success===!1)throw new Error(E.error||"Product fetch failed");const te=Array.isArray(E)?E:[];c.push(...te),k=Math.max(1,Number(B.headers.get("X-WP-TotalPages")||(te.length===L?l+1:l))),l+=1}while(m&&l<=k);const q=[...new Map(c.map(F=>[F.id,F])).values()];if(r!==D.current)return;g(q)}catch(c){if(r!==D.current)return;g([]),T({title:"Products unavailable",description:c instanceof Error?c.message:"Could not search WooCommerce products.",variant:"destructive"})}finally{r===D.current&&y(!1)}},[T]);d.useEffect(()=>{const a=window.setTimeout(()=>{G({search:p,fetchAll:!1})},p.trim()?350:0);return()=>window.clearTimeout(a)},[G,p]);const I=d.useMemo(()=>{const a=j.reduce((c,l)=>c+z(l),0),m=j.reduce((c,l)=>c+Z(l),0),r=j.reduce((c,l)=>c+$(l),0);return{taxable:a,tax:m,grandTotal:r}},[j]),J=d.useMemo(()=>{const a=p.trim().toLowerCase();return a?i.filter(m=>[m.name,m.sku,m.price].filter(Boolean).some(r=>String(r).toLowerCase().includes(a))):i},[p,i]),R=(a,m)=>{C(r=>r.map(c=>c.id===a?{...c,...m}:c))},Ie=(a,m)=>{const r=i.find(c=>String(c.id)===m);R(a,{productId:m,description:(r==null?void 0:r.name)||"",sku:(r==null?void 0:r.sku)||"",unitPrice:Number((r==null?void 0:r.price)||(r==null?void 0:r.regular_price)||0)})},ke=a=>{const m=a;n(m),o(r=>({...r,invoiceNumber:ie(m)}))},Ae=()=>{const a=s==="tax"?"Tax Invoice":"Proforma Invoice",m=s==="tax"?"/paid-letter-rubber-stamp-template_29794-1263.avif":"/unpaid-rubber-stamp-260nw-1203367513.webp",r=s==="tax"?"Paid stamp":"Unpaid stamp",c=j.map((l,k)=>{const L=$(l),_=z(l),q=Z(l);return`
        <tr>
          <td>${k+1}</td>
          <td>
